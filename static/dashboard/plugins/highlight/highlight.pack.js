...
hljs.registerLanguage("javascript", function (e) {
    var r = "[A-Za-z$_][0-9A-Za-z$_]*", t = {
        ...
        c = {b: "html`", e: "", starts: {e: "`", rE: !1, c: [e.BE, s], sL: "xml"}},
        n = {b: "css`", e: "", starts: {e: "`", rE: !1, c: [e.BE, s], sL: "css"}},
    ...
    return {
        ...
        c: [{cN: "meta", r: 10, b: /^\s*['"]use (strict|asm)['"]/}, {
            ...
            c: [e.CLCM, e.CBCM, e.RM, {
                ...
                rB: !0,
                e: "\\s*=>",
                c: [{cN: "params", v: [{b: r}, {b: /\(\s*\)/}, {b: /\(/, e: /\)/, eB: !0, eE: !0, k: t, c: i}]}]
            }, {cN: "", b: /\s/, e: /\s*/, skip: !0}, {
                b: /</,
...
hljs.registerLanguage("xml", function (s) {
    ...
    return {
        ...
        c: [{
            ...
            k: {name: "script"},
            c: [e],
            starts: {e: "<\/script>", rE: !0, sL: ["actionscript", "javascript", "handlebars", "xml", "vbscript"]}
